...
public class Step3_ArrayOfObjects
{
   ...
   {
      demos.C06_Classes.Room[] rooms = new demos.C06_Classes.Room[3];
      ...
      rooms[0] = new demos.C06_Classes.Room("THE OLD LIBRARY", "Dust in the light.", "north");
      rooms[1] = new demos.C06_Classes.Room("THE GALLERY", "Portraits watch you.", "south");
      rooms[2] = new demos.C06_Classes.Room("THE STOREROOM", "A heavy chest.", "west");
