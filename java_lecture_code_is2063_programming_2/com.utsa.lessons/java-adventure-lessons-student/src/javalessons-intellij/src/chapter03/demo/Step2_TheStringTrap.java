 ...
 *
 * Before running, predict all four lines and write a reason for each answer.
 * After running, identify exactly which part of your model must change.
 *
 * This distinction becomes important again when Chapter 8 studies references.
 */
